...
namespace webf
{
    public static class PageNavigationExtension
    {
        ...
        public static MvcHtmlString NavigatorUserHelper(this AjaxHelper html, int elementsCount, int pageRows, int currPage, string actionName, string controllerName)
        {
